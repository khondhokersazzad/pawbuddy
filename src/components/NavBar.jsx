...
<div className="dropdown">
  ...
  >
    <li>
      <NavLink to="/" className={({ isActive }) => (isActive ? "text-purple-700 font-bold" : "")}>
        Home
      </NavLink>
    </li>
    <li>
      <NavLink to="/all-toys" className={({ isActive }) => (isActive ? "text-purple-700 font-bold" : "")}>
        All Toys
      </NavLink>
    </li>
    <li>
      <NavLink to="/profile" className={({ isActive }) => (isActive ? "text-purple-700 font-bold" : "")}>
        My Profile
      </NavLink>
    </li>
  </ul>
